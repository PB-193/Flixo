...
<div align="center">
  <p><strong>YouTube動画を美しくシェアする、次世代プラットフォーム</strong></p>
  <p>モダンなデザインと直感的なUIで、お気に入りのYouTube動画を簡単にシェア・発見できます。</p>
</div>

## ✨ 特徴

- 🎥 **YouTube動画の簡単投稿** - URLをコピペするだけで瞬時に投稿
- 🔍 **プレビュー機能** - ホバー/長押しで動画をその場でプレビュー
- 📱 **完全レスポンシブ** - デスクトップからモバイルまで美しく表示
- ⚡ **高速パフォーマンス** - Next.js 15による最適化されたパフォーマンス
- 🎨 **モダンUI/UX** - グラデーション、アニメーション、ガラスモーフィズム効果
...
### モバイル表示
![Mobile View](test-results/mobile-375x667.png)
...
<div align="center">
  ...
  <p>🎬 <strong>Flixo</strong> - YouTube動画を美しくシェアしよう</p>
</div>